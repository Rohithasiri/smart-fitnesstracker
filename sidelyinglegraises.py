...
# MET value for side-lying leg raises (light to moderate effort)
MET = 3.5
...
def run_sidelying_leg_raises(user_weight, target_reps=10, video_path="Sample Videos/Side lying leg lift.mp4"):
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # Calculate the angle at the knee (optional for form feedback)
    ...
    end_time = time.time()
    elapsed_sec = end_time - start_time if start_time else 0
    elapsed_hr = elapsed_sec / 3600
    calories_burned = MET * user_weight * elapsed_hr
